...
public class Robot extends Group {
	...
	private int NUMBER_OF_ROBOTS = 0;
	...
	public void addToStack(Operation o) {
		stack.add(o);
	}

	public boolean checkBlockCollision(Block b) {
		...
		if (collision) {
			if( b instanceof PressurePlate){
				((PressurePlate)b).isPressed();
			}
